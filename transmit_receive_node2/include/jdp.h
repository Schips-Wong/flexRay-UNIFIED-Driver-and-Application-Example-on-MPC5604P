...
/****************************************************************************/
    struct ADC_tag {
        ...
        } CLR0;                 /* ADC CONTROL LOGIC REGISTER0 */

        union {
            vuint32_t R;
            struct {
                vuint32_t:28;
                vuint32_t TRIGSTART:1;
                vuint32_t JTRGEN:1;
                vuint32_t JEDGE:1;
                vuint32_t JSTART:1;
            } B;
        } CLR1;                 /* ADC CONTROL LOGIC REGISTER1 */
        ...
        } CLR2;                 /* ADC CONTROL LOGIC REGISTER2 */
        ...
        } CLR3;                 /* ADC CONTROL LOGIC REGISTER3 */

        union {
            vuint32_t R;
            struct {
                vuint32_t:16;
                vuint32_t OFFLATCH:1;
                vuint32_t OFFLOAD:1;
                vuint32_t OFFCANC:1;
        ...
        } CLR4;                 /* ADC CONTROL LOGIC REGISTER4 */
        ...
        } TRA[4];               /* ADC THRESHOLD REGISTER REGISTER */
        ...
        } TRB[4];               /* ADC THRESHOLD REGISTER REGISTER */
        ...
        } TRAALT[4];            /* ADC THRESHOLD REGISTER REGISTER */
        ...
        } TRBALT[4];            /* ADC THRESHOLD REGISTER REGISTER */
        ...
        } WDGTHR;               /* WATCHDOG INTERRUPT THRESHOLD REGISTER */
        ...
        } IMWDGTHR;             /* WATCHDOG INTERRUPT MASK REGISTER */
        ...
        } PREREG;               /* PRESAMPLING CONTROL REGISTER */
        ...
        } NCMR[6];              /* NORMAL CONVERSION MASK REGISTER */
        ...
        } ICMR[6];              /* NORMAL CONVERSION MASK REGISTER */
        ...
        } CT[3];                /* CONVERSION TIMING REGISTER */
        ...
        } OFFREG;               /* OFFSET WORD REGISTER */

        union {
            vuint32_t R;
            struct {
                vuint32_t:24;
                vuint32_t EXT_OFF_WORD:8;
            } B;
        } EXTOFFREG;            /* EXTERNAL OFFSET WORD REGISTER */
        ...
        } DSD;                  /* DECODE SIGNALS DELAY REGISTER */
        ...
        } PDD;                  /* POWER DOWN DELAY REGISTER */

        int32_t ADC_reserved1[2];       /* (0x100 - 0x0F8)/4 = 0x02 */

        union {
            vuint32_t R;
            struct {
                vuint32_t:20;
                vuint32_t PRECDATAREG:12;
            } B;
        } PRECDATAREG[32];      /* Channel 0-31 Data REGISTER */

        union {
            vuint32_t R;
            struct {
                vuint32_t:20;
                vuint32_t INTDATAREG:12;
            } B;
        } INTDATAREG[32];       /* Channel 63 Data REGISTER */

        union {
            vuint32_t R;
            struct {
                vuint32_t:20;
                vuint32_t EXTDATAREG:12;
            } B;
        } EXTDATAREG0[8];       /* Channel 64 Data REGISTER */
        ...
        } EXTDATAREG1[8];       /* Channel 65 Data REGISTER */
        ...
        } EXTDATAREG2[8];       /* Channel 66 Data REGISTER */
        ...
        } EXTDATAREG3[8];       /* Channel 67 REGISTER */
        ...
        } PRECDATACNTRLREG[32]; /* Channel 0-31 Data Control REGISTER */
        ...
        } INTDATACNTRLREG[32];  /* Channel 32-63 Data Control REGISTER */
        ...
        } EXTDATACNTRLREG[3];   /* Channel 64-66 Data Control REGISTER */
    ...
    struct FLEXPWM_SUB_tag {
        ...
        union {
            ...
            struct {
                ...
                vuint16_t WAITEN:1;
                vuint16_t INDEP:1;
                vuint16_t PWM23_INIT:1;
                vuint16_t PWM45_INIT:1;
