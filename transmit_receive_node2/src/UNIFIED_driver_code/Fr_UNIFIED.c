...
volatile uint16 PTR2FARREG Fr_CC_reg_ptr;
...
/* The FR_NUMBER_TXRX_MB parameter is defined in the Fr_UNIFIED_cfg.h file 
   - memory consumption optimization is applied */
    ...
    static Fr_MB_information_internal_type Fr_MB_information_internal[FR_NUMBER_TXRX_MB + 1U];
#else
                       ...
                       const Fr_low_level_config_type *Fr_low_level_config_temp_ptr)
{
    ...
    uint8 i = 0U;                /* Temporary counter */
    /* Initialize the base address */
    Fr_CC_reg_ptr = (volatile uint16 PTR2FARREG) Fr_HW_config_temp_ptr->CC_base_address;
    ...
    {
        Fr_CC_reg_ptr[FrSYMBADHR] = (uint16)(Fr_HW_config_temp_ptr->CC_FlexRay_memory_base_address >> 16U);
        Fr_CC_reg_ptr[FrSYMBADLR] = (uint16)(Fr_HW_config_temp_ptr->CC_FlexRay_memory_base_address & 0xffffU);
    }
    ...
    {
        if(Fr_HW_config_temp_ptr->timeout != 0U)     /* Stored only if the value is not equal to 0 */
        {
            /* Store the value of the TIMEOUT bit field in the SYMATOR register */
            Fr_CC_reg_ptr[FrSYMATOR] = (Fr_HW_config_temp_ptr->timeout & 0x1FU);
        }
    }
    
    /* Configuration of the MCR register */
    temp_value = 0x0000U;        /* Clear temporary variable */
    ...
    {
	  /* No channel configured on error */
	}
    ...
    if(Fr_connected_HW != FR_MFR4300)  /* Not necessary for the MFR4300 */
    {
       ...
       temp_value |=  (uint16)((Fr_HW_config_temp_ptr->prescaler_value & 0x07U) << 1U);
    }
    ...
    i = 0U;      /* Clear temporary counter */
    while((i < FR_MAX_WAIT_CYCLES) && ( (Fr_CC_reg_ptr[FrPSR0] & 0x0700U) != FrPSR0_PROTSTATE_CONFIG))
    {
        i++;        /* Increment temporary counter */
    }
    if(i == FR_MAX_WAIT_CYCLES) 
                          ...
                          const Fr_low_level_config_type *Fr_low_level_config_temp_ptr)
{
    ...
    /* The FR_NUMBER_TXRX_MB parameter is defined in the Fr_UNIFIED_cfg.h file 
    - memory consumption optimization is applied */
        for(Fr_p = 0U; Fr_p < (FR_NUMBER_TXRX_MB + 1U); Fr_p++) /* Configure limited number of items */
        {
            Fr_MB_information_internal[Fr_p].Fr_MB_function_ptr = NULL; /* Set callback function to NULL */
            Fr_MB_information_internal[Fr_p].slot_number = 0U;           /* Clear slot number item */
    ...
    /* PCR0 */
    temp_value_1 = 0x0000U;
    temp_value_1 = (uint16)(Fr_low_level_config_ptr->GD_ACTION_POINT_OFFSET - 1U);
    temp_value_1 = (uint16)((uint16)(temp_value_1 << 10U) | Fr_low_level_config_ptr->GD_STATIC_SLOT);
    Fr_CC_reg_ptr[FrPCR0] = temp_value_1;

    /* PCR1  */
    temp_value_1 = 0x0000U;
    temp_value_1 = (uint16)((uint16)(temp_value_1 << 14U) | \
                   (Fr_low_level_config_ptr->G_MACRO_PER_CYCLE - Fr_low_level_config_ptr->GD_STATIC_SLOT));
    Fr_CC_reg_ptr[FrPCR1] = temp_value_1;
    
    /* PCR2  */
    temp_value_1 = 0x0000U;
    temp_value_1 = (uint16)((Fr_low_level_config_ptr->GD_MINISLOT - \
                   Fr_low_level_config_ptr->GD_MINI_SLOT_ACTION_POINT_OFFSET) - 1U);
    temp_value_1 = (uint16)((uint16)(temp_value_1 << 10U) | Fr_low_level_config_ptr->G_NUMBER_OF_STATIC_SLOTS);
    Fr_CC_reg_ptr[FrPCR2] = temp_value_1;

    /* PCR3  */
    temp_value_1 = 0x0000U;
    temp_value_1 = Fr_low_level_config_ptr->GD_WAKEUP_SYMBOL_RX_LOW;
    temp_value_1 = (uint16)((uint16)(temp_value_1 << 5U) | (Fr_low_level_config_ptr->GD_MINI_SLOT_ACTION_POINT_OFFSET - 1U));
    temp_value_1 = (uint16)((uint16)(temp_value_1 << 5U) | Fr_low_level_config_ptr->G_COLD_START_ATTEMPTS);
    Fr_CC_reg_ptr[FrPCR3] = temp_value_1;

    /* PCR4  */
    temp_value_1 = 0x0000U;
    temp_value_1 = (uint16)(Fr_low_level_config_ptr->GD_CAS_RX_LOW_MAX - 1U);
    temp_value_1 = (uint16)((uint16)(temp_value_1 << 9U) | Fr_low_level_config_ptr->GD_WAKEUP_SYMBOL_RX_WINDOW);
    Fr_CC_reg_ptr[FrPCR4] = temp_value_1;

    /* PCR5  */
    temp_value_1 = 0x0000U;
    temp_value_1 = Fr_low_level_config_ptr->GD_TSS_TRANSMITTER;
    temp_value_1 = (uint16)((uint16)(temp_value_1 << 6U) | Fr_low_level_config_ptr->GD_WAKEUP_SYMBOL_TX_LOW);
    temp_value_1 = (uint16)((uint16)(temp_value_1 << 6U) | Fr_low_level_config_ptr->GD_WAKEUP_SYMBOL_RX_IDLE);
    Fr_CC_reg_ptr[FrPCR5] = temp_value_1;

    /* PCR6  */
    temp_value_1 = 0x0000U;
    temp_value_1 = (uint16)((Fr_low_level_config_ptr->GD_SYMBOL_WINDOW - Fr_low_level_config_ptr->GD_ACTION_POINT_OFFSET) - 1U);
    temp_value_1 = (uint16)((uint16)(temp_value_1 << 7U) | Fr_low_level_config_ptr->P_MACRO_INITIAL_OFFSET_A);
    Fr_CC_reg_ptr[FrPCR6] = temp_value_1;

    /* PCR7  */
    temp_value_1 = 0x0000U;
    temp_value_1 = (uint16)(Fr_low_level_config_ptr->P_DECODING_CORRECTION + \
                   Fr_low_level_config_ptr->P_DELAY_COMPENSATION_CHB + 2U);
    temp_value_1 = (uint16)((uint16)(temp_value_1 << 7U) | (Fr_low_level_config_ptr->P_MICRO_PER_MACRO_NOM / 2U));
    Fr_CC_reg_ptr[FrPCR7] = temp_value_1;

    /* PCR8  */
    temp_value_1 = 0x0000U;
    temp_value_1 = Fr_low_level_config_ptr->G_MAX_WITHOUT_CLOCK_CORRECTION_FATAL;
    temp_value_1 = (uint16)((uint16)(temp_value_1 << 4U) | Fr_low_level_config_ptr->G_MAX_WITHOUT_CLOCK_CORRECTION_PASSIVE);
    temp_value_1 = (uint16)((uint16)(temp_value_1 << 8U) | Fr_low_level_config_ptr->GD_WAKEUP_SYMBOL_TX_IDLE);
    Fr_CC_reg_ptr[FrPCR8] = temp_value_1;
    
    /* PCR9  */
    temp_value_1 = 0x0000U;
    if(Fr_low_level_config_ptr->G_NUMBER_OF_MINISLOTS != 0U)
    {
      temp_value_1 = TRUE;
    }
    else                                                  
    ...
    if(Fr_low_level_config_ptr->GD_SYMBOL_WINDOW != 0U)
    {
      temp_value_3 = TRUE;
    } 
    else
    ...
    temp_value_1 = (uint16)((uint16)(temp_value_1 << 1U) | temp_value_3);
    temp_value_1 = (uint16)((uint16)(temp_value_1 << 14U) | Fr_low_level_config_ptr->P_OFFSET_CORRECTION_OUT);
    Fr_CC_reg_ptr[FrPCR9] = temp_value_1;

    /* PCR10  */
    temp_value_1 = 0x0000U;
    temp_value_1 = Fr_low_level_config_ptr->P_SINGLE_SLOT_ENABLED;
    temp_value_1 = (uint16)((uint16)(temp_value_1 << 1U) | (uint16)Fr_low_level_config_ptr->P_WAKEUP_CHANNEL);
    temp_value_1 = (uint16)((uint16)(temp_value_1 << 14U) | Fr_low_level_config_ptr->G_MACRO_PER_CYCLE);
    Fr_CC_reg_ptr[FrPCR10] = temp_value_1;
      
    /* PCR11  */
    temp_value_1 = 0x0000U;
    temp_value_1 = Fr_low_level_config_ptr->P_KEY_SLOT_USED_FOR_STARTUP;
    temp_value_1 = (uint16)((uint16)(temp_value_1 << 1U) | Fr_low_level_config_ptr->P_KEY_SLOT_USED_FOR_SYNC);
    temp_value_1 = (uint16)((uint16)(temp_value_1 << 14U) | Fr_low_level_config_ptr->G_OFFSET_CORRECTION_START);
    Fr_CC_reg_ptr[FrPCR11] = temp_value_1;

    /* PCR12  */
    temp_value_1 = 0x0000U;
    temp_value_1 = Fr_low_level_config_ptr->P_ALLOW_PASSIVE_TO_ACTIVE;
    temp_value_1 = (uint16)((uint16)(temp_value_1 << 11U) | Fr_low_level_config_ptr->P_KEY_SLOT_HEADER_CRC);
    ...
    {
      temp_value_1 = (uint16)(Fr_low_level_config_ptr->GD_MINI_SLOT_ACTION_POINT_OFFSET - 1U);
    }  
    temp_value_1 = (uint16)(temp_value_1 << 10U);
    temp_value_1 |= (uint16)((Fr_low_level_config_ptr->GD_STATIC_SLOT -  Fr_low_level_config_ptr->GD_ACTION_POINT_OFFSET) - 1U);
    Fr_CC_reg_ptr[FrPCR13] = temp_value_1;
    
    /* PCR14  */
    temp_value_1 = 0x0000U;
    temp_value_2 = 0x00000000U;
    temp_value_2 = (Fr_low_level_config_ptr->PD_LISTEN_TIMEOUT - 1U) & 0x001F0000U;
    temp_value_1 = Fr_low_level_config_ptr->P_RATE_CORRECTION_OUT;
    temp_value_1 = (uint16)((uint16)(temp_value_1 <<5U) | ((uint16)(temp_value_2 >> 16U)));
    Fr_CC_reg_ptr[FrPCR14] = temp_value_1;
    
    /* PCR15  */
    temp_value_1 = 0x0000U;
    temp_value_2 = 0x00000000U;
    temp_value_2 = (Fr_low_level_config_ptr->PD_LISTEN_TIMEOUT - 1U) & 0x0000FFFFU;
    ...
    temp_value_2 = ((Fr_low_level_config_ptr->G_LISTEN_NOISE * Fr_low_level_config_ptr->PD_LISTEN_TIMEOUT) - 1U) & 0x01FF0000U;
    temp_value_1 = (uint16)((uint16)(temp_value_1 << 9U ) | ((uint16)(temp_value_2 >> 16U)));
    Fr_CC_reg_ptr[FrPCR16] = temp_value_1;
    
    /* PCR17  */
    temp_value_1 = 0x0000U;
    temp_value_2 = 0x00000000U;
    temp_value_2 = ((Fr_low_level_config_ptr->G_LISTEN_NOISE * Fr_low_level_config_ptr->PD_LISTEN_TIMEOUT) - 1U) & 0x0000FFFFU;
    temp_value_1 = (uint16)temp_value_2;
    ...
    temp_value_1 = (uint16)((uint16)(temp_value_1 << 10U) | Fr_low_level_config_ptr->P_KEY_SLOT_ID);
    Fr_CC_reg_ptr[FrPCR18] = temp_value_1;
    
    /* PCR19  */
    temp_value_1 = 0x0000U;
    temp_value_1 = (uint16)(Fr_low_level_config_ptr->P_DECODING_CORRECTION + \
                   Fr_low_level_config_ptr->P_DELAY_COMPENSATION_CHA + 2U);
    temp_value_1 = (uint16)((uint16)(temp_value_1 << 7U) | Fr_low_level_config_ptr->G_PAYLOAD_LENGTH_STATIC);
    Fr_CC_reg_ptr[FrPCR19] = temp_value_1;

    /* PCR20  */
    temp_value_1 = 0x0000U;
    temp_value_1 = Fr_low_level_config_ptr->P_MICRO_INITIAL_OFFSET_B;
    temp_value_1 = (uint16)((uint16)(temp_value_1 << 8U) | Fr_low_level_config_ptr->P_MICRO_INITIAL_OFFSET_A);
    Fr_CC_reg_ptr[FrPCR20] = temp_value_1;
        
    /* PCR21  */
    temp_value_1 = 0x0000U;
    temp_value_1 = Fr_low_level_config_ptr->P_EXTERN_RATE_CORRECTION;
    temp_value_1 = (uint16)((uint16)(temp_value_1 << 13U) | \
                   (Fr_low_level_config_ptr->G_NUMBER_OF_MINISLOTS - Fr_low_level_config_ptr->P_LATEST_TX));
    Fr_CC_reg_ptr[FrPCR21] = temp_value_1;
    
    /* PCR22  */
    temp_value_1 = 0x0000U;
    temp_value_2 = 0x00000000U;
    temp_value_1 = (uint16)(Fr_low_level_config_ptr->PD_ACCEPTED_STARTUP_RANGE - \
                   Fr_low_level_config_ptr->P_DELAY_COMPENSATION_CHA);
    temp_value_2 = (Fr_low_level_config_ptr->P_MICRO_PER_CYCLE) & 0x000F0000U;
    temp_value_1 = (uint16)((uint16)(temp_value_1 << 4U) | ((uint16)(temp_value_2 >> 16U)));
    Fr_CC_reg_ptr[FrPCR22] = temp_value_1;
    
    /* PCR23  */
    temp_value_1 = 0x0000U;
    temp_value_2 = 0x00000000U;
    temp_value_2 = Fr_low_level_config_ptr->P_MICRO_PER_CYCLE & 0x0000FFFFU;
    temp_value_1 = (uint16)temp_value_2;
    ...
    temp_value_1 = (uint16)((uint16)(temp_value_1 << 7U) | Fr_low_level_config_ptr->P_PAYLOAD_LENGTH_DYN_MAX);
    temp_value_2 = (Fr_low_level_config_ptr->P_MICRO_PER_CYCLE - Fr_low_level_config_ptr->PD_MAX_DRIFT) & 0x000F0000U;
    temp_value_1 = (uint16)((uint16)(temp_value_1 << 4U) | ((uint16)(temp_value_2 >> 16U)));
    ...
    temp_value_1 = 0x0000U;
    temp_value_2 = 0x00000000U;
    temp_value_2 = (Fr_low_level_config_ptr->P_MICRO_PER_CYCLE - Fr_low_level_config_ptr->PD_MAX_DRIFT) & 0x0000FFFFU;
    temp_value_1 = (uint16)temp_value_2;
    ...
    temp_value_1 = (uint16)(temp_value_1 << 11U);
    ...
    temp_value_1 = (uint16)(temp_value_1 << 14U);
    ...
    temp_value_1 = (uint16)((uint16)(temp_value_1 << 13U) | (Fr_low_level_config_ptr->G_NUMBER_OF_MINISLOTS - 1U));
    ...
    temp_value_1 = (uint16)(temp_value_1 << 8U);
    temp_value_1 = (uint16)(temp_value_1 | ((uint16)(Fr_HW_config_ptr->MB_segment_1_data_size)));

    /* Message Buffer Segment Size and Utilization Register initialization */
    temp_value_3 = (uint16)(Fr_HW_config_ptr->last_MB_seg_1);
    temp_value_3 = (uint16)(temp_value_3 << 8U);
    temp_value_3 = (uint16)(temp_value_3 | (uint16)(Fr_HW_config_ptr->last_MB_util));
    ...
    else                                          /* Modification for the MPC5567 (only for Rev 0) - errata no. MUCts02955 */
    {
        ...
        temp_value_2 = (uint32)(temp_value_2 << 16U);      /* Move bits to higher part of 32-bit variable */
        temp_value_2 |= (uint32) temp_value_3;    /* Copy value of the MBSSUTR register to lower part of 32-bit variable */
        Fr_CC_reg_32_ptr[FrMBDSR / 2U] = temp_value_2; /* Write the MBSSUTR configuration into MBDSR register, bug MUCts02955 */
    ...
    /* SFTOR */
    if(Fr_HW_config_temp_ptr->sync_frame_table_offset != 0U)     /* Stored only if the value is not equal to 0 */
    {
    ...
    Fr_CC_reg_ptr[FrGIFER] = 0x0000U;
    Fr_CC_reg_ptr[FrPIER0] = 0x0000U;
    Fr_CC_reg_ptr[FrPIER1] = 0x0000U;
                     ...
                     const Fr_index_selector_type *Fr_buffer_config_set_temp_ptr)
{
    ...
    /* The highest number of configured transmit or receive MB index -for verification */
    volatile uint8 highest_txrx_mb_number = 0U;  
    ...
    volatile uint16 PTR2FARDATA header_MB_ptr; /* Message buffer header pointer */
    ...
    Fr_FIFO_info.FIFO_1_depth = 0U;
    Fr_FIFO_info.FIFO_1_entry_size = 0U;
    Fr_FIFO_info.FIFO_2_used = FALSE;
    Fr_FIFO_info.FIFO_2_channel = FR_NO_CHANNEL;
    Fr_FIFO_info.FIFO_2_depth = 0U;
    Fr_FIFO_info.FIFO_2_entry_size = 0U;
    ...
    while(Fr_buffer_config_set_ptr[temp_index] != FR_LAST_MB)   /* Configure all required MBs */
    {
        ...
        Fr_MB_registers_offset_add_temp = (uint16)(Fr_buffers_config_ptr[Fr_buffer_info_set_index].buffer_index_init * 4U);
        ...
        case FR_RECEIVE_BUFFER:         /* Configure receive MB */
            ...
            temp_value_2 = 0x0000U;      /* Clear variable */
            ...
            temp_value_1 = 0x0000U;      /* Clear variable */
            ...
            {
                temp_value_2 = 0x0000U;
                /* Cycle counter filter value */
                temp_value_1 |= (uint16)(Fr_receive_buffer_config_ptr->rx_cycle_counter_filter_value & 0x3FU); 
                /* Cycle counter filter mask */
                temp_value_2 =  (uint16)(Fr_receive_buffer_config_ptr->rx_cycle_counter_filter_mask & 0x3FU);
                temp_value_1 |= (uint16)(temp_value_2 << 6U);
                temp_value_1 |= FrMBCCFR_CCFE;  /* Cycle counter filter enabled */
            }
            /* Store configuration into MBCCFRn register */
            Fr_CC_reg_ptr[FrMBCCFR0 + Fr_MB_registers_offset_add_temp] = temp_value_1; 
            ...
            header_MB_ptr = ((volatile uint16 PTR2FARDATA)(Fr_HW_config_ptr->CC_FlexRay_memory_base_address) + \
                            (Fr_buffers_config_ptr[Fr_buffer_info_set_index].buffer_index_init * 5U));
            
            /* Check if the message buffer is in segment 1 or segment 2 */
            if(Fr_buffers_config_ptr[Fr_buffer_info_set_index].buffer_index_init < (Fr_HW_config_ptr->last_MB_seg_1 + 1U))
            {   /* Payload data of MB are in segment 1 */
                ...
                temp_value_2 = (uint16)((Fr_HW_config_ptr->total_MB_number * 10U) + \
                               (Fr_buffers_config_ptr[Fr_buffer_info_set_index].buffer_index_init * \
                               Fr_HW_config_ptr->MB_segment_1_data_size * 2U));
            }
            else /* Payload data of MB are in segment 2 */
            {
                ...
                temp_value_2 = (uint16)((Fr_HW_config_ptr->total_MB_number * 10U) + \
                               ((Fr_HW_config_ptr->last_MB_seg_1 + 1U) * Fr_HW_config_ptr->MB_segment_1_data_size * 2U) + \
                               ((Fr_buffers_config_ptr[Fr_buffer_info_set_index].buffer_index_init - \
                               (Fr_HW_config_ptr->last_MB_seg_1 + 1U)) * Fr_HW_config_ptr->MB_segment_2_data_size * 2U));
            }
            header_MB_ptr[3U] = temp_value_2;    /* Store Data Field Offset to Frame header register */
            ...
            {
                highest_txrx_mb_number = (uint8) temp_value_1;      /* Update variable with the highest index number */
            }
            ...
            temp_value_1 = (uint16)(Fr_CC_reg_ptr[FrMBCCSR0 + Fr_MB_registers_offset_add_temp] | FrMBCCSR_EDT);
            Fr_CC_reg_ptr[FrMBCCSR0 + Fr_MB_registers_offset_add_temp] = temp_value_1;
        ...
        case FR_TRANSMIT_BUFFER:        /* Configure transmit MB */
            ...
            {
                /* Disable appropriate MB */
                if(Fr_CC_reg_ptr[FrMBCCSR0 + Fr_MB_registers_offset_add_temp + 4U] & FrMBCCSR_EDS)
                {
                    Fr_CC_reg_ptr[FrMBCCSR0 + Fr_MB_registers_offset_add_temp + 4U] = temp_value_1;
                }
            }
            
            /* Configure MBCCSRn register */
            temp_value_2 = FrMBCCSR_MTD;    /* Configure MB as Transmit */
            temp_value_3 = 0x0000U;          /* Clear temporary variable */
            ...
            if(Fr_transmit_buffer_config_ptr->transmit_MB_buffering == FR_DOUBLE_TRANSMIT_BUFFER)
            {
                ...
                Fr_MB_information_internal[Fr_buffers_config_ptr[Fr_buffer_info_set_index].buffer_index_init + 1U].
                                            transmission_mode =  FR_DOUBLE_TRANSMIT_BUFFER;
            }
            else
            {
            ...
            if(Fr_transmit_buffer_config_ptr->transmit_MB_buffering == FR_DOUBLE_TRANSMIT_BUFFER)
            {
                ...
                Fr_CC_reg_ptr[FrMBCCSR0 + Fr_MB_registers_offset_add_temp + 4U] = temp_value_2;
            }
            ...
            if(Fr_transmit_buffer_config_ptr->tx_cycle_counter_filter_enable)    /* Should be the cycle counter filter enabled? */
            {
                temp_value_2 = 0x0000U;
                /* Cycle counter filter value */
                temp_value_1 |= (uint16)(Fr_transmit_buffer_config_ptr->tx_cycle_counter_filter_value & 0x3FU); 
                /* Cycle counter filter mask */
                temp_value_2 =  (uint16)(Fr_transmit_buffer_config_ptr->tx_cycle_counter_filter_mask & 0x3FU);
                temp_value_1 |= (uint16)(temp_value_2 << 6U);
                temp_value_1 |= FrMBCCFR_CCFE;  /* Cycle counter filter enabled */
            }
            ...
            Fr_CC_reg_ptr[FrMBCCFR0 + Fr_MB_registers_offset_add_temp] = temp_value_1; /* Store config. into MBCCFRn register */
            /* Store configuration into transmit side of the double buffered MB */
            if(Fr_transmit_buffer_config_ptr->transmit_MB_buffering == FR_DOUBLE_TRANSMIT_BUFFER)
            {
                /* Store configuration into the MBCCFR[2n+1] register */
                Fr_CC_reg_ptr[FrMBCCFR0 + Fr_MB_registers_offset_add_temp + 4U] = temp_value_1;
            }
            ...
            if(Fr_transmit_buffer_config_ptr->transmit_MB_buffering == FR_DOUBLE_TRANSMIT_BUFFER)
            {
                ...
                Fr_CC_reg_ptr[FrMBFIDR0 + Fr_MB_registers_offset_add_temp + 4U] = Fr_transmit_buffer_config_ptr->transmit_frame_ID;
            }
            ...
            temp_value_1 = 0x0000U;          /* Clear */
            temp_value_1 |= (Fr_transmit_buffer_config_ptr->transmit_frame_ID & 0x07FFU);    /* Frame ID */
            ...
            header_MB_ptr[0U] = temp_value_1;        /* Store the first word of Frame Header Section */
            /* Store configuration into transmit side of the double buffered MB */
            if(Fr_transmit_buffer_config_ptr->transmit_MB_buffering == FR_DOUBLE_TRANSMIT_BUFFER)
            {
                /* Store configuration into the first word of Frame Header Section */
                header_MB_ptr[0U+5U] = temp_value_1;        /* Store the first word of Frame Header Section */
            }

            temp_value_2 = 0x0000U;          /* Clear */
            temp_value_2 |= (Fr_transmit_buffer_config_ptr->payload_length & 0x007FU);    /* Payload length */
            header_MB_ptr[1U] = temp_value_2;        /* Store the second word of Frame Header Section */
            /* Store configuration into transmit side of the double buffered MB */
            if(Fr_transmit_buffer_config_ptr->transmit_MB_buffering == FR_DOUBLE_TRANSMIT_BUFFER)
            {
                /* Store configuration into the second word of Frame Header Section */
                header_MB_ptr[1U+5U] = temp_value_2;        /* Store the second word of Frame Header Section */
            }


            temp_value_1 = 0x0000U;          /* Clear */
            temp_value_1 |= (Fr_transmit_buffer_config_ptr->header_CRC & 0x07FFU);       /* Header CRC */
            header_MB_ptr[2U] = temp_value_1;        /* Store the third word of Frame Header Section */
            /* Store configuration into transmit side of the double buffered MB */
            if(Fr_transmit_buffer_config_ptr->transmit_MB_buffering == FR_DOUBLE_TRANSMIT_BUFFER)
            {
                /* Store configuration into the third word of Frame Header Section */
                header_MB_ptr[2U+5U] = temp_value_1;        /* Store the third word of Frame Header Section */
            }
            ...
            {   /* Payload data of MB are in segment 1 */
                ...
                if(Fr_transmit_buffer_config_ptr->transmit_MB_buffering == FR_DOUBLE_TRANSMIT_BUFFER)
                {
                    ...
                    temp_value_1 = (uint16)(temp_value_2 + (Fr_HW_config_ptr->MB_segment_1_data_size * 2U));
                }
            }
            else /* Payload data of MB are in segment 2 */
            {
                ...
                if(Fr_transmit_buffer_config_ptr->transmit_MB_buffering == FR_DOUBLE_TRANSMIT_BUFFER)
                {
                    ...
                    temp_value_1 = (uint16)(temp_value_2 + (Fr_HW_config_ptr->MB_segment_2_data_size * 2U));
                }
            }
            header_MB_ptr[3U] = temp_value_2;    /* Store Data Field Offset to Frame header register */
            /* Store configuration into transmit side of the double buffered MB */
            if(Fr_transmit_buffer_config_ptr->transmit_MB_buffering == FR_DOUBLE_TRANSMIT_BUFFER)
            {
                ...
                header_MB_ptr[3U+5U] = temp_value_1;        /* Store Data Field Offset to Frame header register */
            }
            ...
            if(Fr_transmit_buffer_config_ptr->transmit_MB_buffering == FR_DOUBLE_TRANSMIT_BUFFER)
            {
                ...
                Fr_CC_reg_ptr[FrMBIDXR0 + Fr_MB_registers_offset_add_temp + 4U] = (uint16)(temp_value_1 + 1U);
                
                /* Store the highest number of message buffer index into variable for optimization verification */
                if(highest_txrx_mb_number < (temp_value_1 + 1U))
                {
                    highest_txrx_mb_number = (uint8)(temp_value_1 + 1U);      /* Update variable with the highest index number */
                }
            }
        ...
        case FR_RECEIVE_FIFO:           /* Configure receive FIFO storage */
            ...
            {   /* FIFO A */
                Fr_CC_reg_ptr[FrRFSR] = 0x0000U;                     /* Set channel A in Receive FIFO Selection reg. */
                ...
                {                                       /* No FIFO storage has been configured yet */
                    ...
                    temp_value_2 = (uint16)((Fr_HW_config_ptr->total_MB_number * 10U) + \
                                   ...
                                   Fr_HW_config_ptr->MB_segment_2_data_size * 2U));
                ...
                else                                    /* One FIFO storage has already been configured */
                {
                    ...
                    temp_value_2 = (uint16)((Fr_HW_config_ptr->total_MB_number * 10U) + \
                                   ((Fr_HW_config_ptr->last_MB_seg_1 + 1U) * Fr_HW_config_ptr->MB_segment_1_data_size * 2U) + \
                                   ((Fr_HW_config_ptr->last_MB_util - Fr_HW_config_ptr->last_MB_seg_1) * \
                                   Fr_HW_config_ptr->MB_segment_2_data_size * 2U) + (Fr_FIFO_info.FIFO_1_depth * \
                                   Fr_FIFO_info.FIFO_1_entry_size * 2U));
                ...
                for(Fr_p = 0U; Fr_p < Fr_FIFO_config_ptr->FIFO_depth; Fr_p++)   /* Configure all MB Header Fields */
                {
                    /* Calculate Data Field Offset for current configured buffer */
                    temp_value_1 = (uint16)(temp_value_2 + (Fr_p * Fr_FIFO_config_ptr->FIFO_entry_size * 2U));
                    /* Calculate the message buffer header  */
                    header_MB_ptr = ((volatile uint16 PTR2FARDATA)(Fr_HW_config_ptr->CC_FlexRay_memory_base_address) + \
                            ((Fr_buffers_config_ptr[Fr_buffer_info_set_index].buffer_index_init + Fr_p) * 5U));
                    header_MB_ptr[3U] = temp_value_1;    /* Store Data Field Offset to Frame header register */
                }
            }
            else
            {   /* FIFO B */
                Fr_CC_reg_ptr[FrRFSR] = 0x0001U;                     /* Set channel B in Receive FIFO Selection reg. */
            ...
            temp_value_2 = 0x0000U;      /* Clear */
            temp_value_2 |= (Fr_buffers_config_ptr[Fr_buffer_info_set_index].buffer_index_init & 0x03FFU); /* Load start index */
            Fr_CC_reg_ptr[FrRFSIR] = temp_value_2;  /* Store start index */
            
            /* Configure FIFO Depth and Size reg. */
            temp_value_1 = 0x0000U;      /* Clear variable */
            temp_value_1 |= (Fr_FIFO_config_ptr->FIFO_entry_size & 0x7FU);   /* Entry size [Words] */
            temp_value_1 |= (uint16)(Fr_FIFO_config_ptr->FIFO_depth << 8U);          /* FIFO Depth */
            ...
            temp_value_2 = 0x0000U;      /* Clear */
            temp_value_2 |= (Fr_FIFO_config_ptr->FIFO_frame_ID_rejection_filter_value & 0x07FFU);    /* Rejection filter value */
            Fr_CC_reg_ptr[FrRFFIDRFVR] = temp_value_2;                      /* Store filter value */
            
            /* Configure FIFO Frame ID Rejection Filter Mask */
            temp_value_1 = 0x0000U;      /* Clear */
            temp_value_1 |= (Fr_FIFO_config_ptr->FIFO_frame_ID_rejection_filter_mask & 0x07FFU);    /* Rejection filter mask */
            ...
            /* Range filter 0 */
            if(Fr_FIFO_config_ptr->FIFO_range_filters_config[0U].range_filter_enable)  /* Range filter 0 enabled? */
            {
                temp_value_1 = 0x0000U;                      /* Clear + set filter Selector - filter 0 */
                /* Set Lower IntervalU Boundary Slot ID */
                temp_value_1 |= (Fr_FIFO_config_ptr->FIFO_range_filters_config[0U].range_filter_lower_interval & 0x07FFU);
                Fr_CC_reg_ptr[FrRFRFCFR] = temp_value_1;    /* Store Range filter 0 settings */
            
                temp_value_2 = 0x0000U;                      /* Clear + set filter Selector - filter 0 */
                temp_value_2 |= FrRFRFCFR_IBD;              /* Program upper interval boundary */
                /* Set Upper Interval Boundary Slot ID */
                temp_value_2 |= (Fr_FIFO_config_ptr->FIFO_range_filters_config[0U].range_filter_upper_interval & 0x07FFU);  
                Fr_CC_reg_ptr[FrRFRFCFR] = temp_value_2;    /* Store Range filter 0 settings */
            }
        
            /* Range filter 1 */
            if(Fr_FIFO_config_ptr->FIFO_range_filters_config[1U].range_filter_enable)  /* Range filter 1 enabled? */
            {
                temp_value_1 = 0x0000U;                      /* Clear */
                temp_value_1 |= 0x1000U;                     /* Set Filter SELector - filter 1 */
                /* Set Lower Interval Boundary Slot ID */
                temp_value_1 |= (Fr_FIFO_config_ptr->FIFO_range_filters_config[1U].range_filter_lower_interval & 0x07FFU);
                Fr_CC_reg_ptr[FrRFRFCFR] = temp_value_1;    /* Store Range filter 1 settings */
            
                temp_value_2 = 0x0000U;                      /* Clear */
                temp_value_2 |= 0x1000U;                     /* Set Filter SELector - filter 1 */
                temp_value_2 |= FrRFRFCFR_IBD;              /* Program upper interval boundary */
                /* Set Upper Interval Boundary Slot ID */
                temp_value_2 |= (Fr_FIFO_config_ptr->FIFO_range_filters_config[1U].range_filter_upper_interval & 0x07FFU);
                Fr_CC_reg_ptr[FrRFRFCFR] = temp_value_2;    /* Store Range filter 1 settings */
            }
            
            /* Range filter 2 */
            if(Fr_FIFO_config_ptr->FIFO_range_filters_config[2U].range_filter_enable)  /* Range filter 2 enabled? */
            {
                temp_value_1 = 0x0000U;                      /* Clear */
                temp_value_1 |= 0x2000U;                     /* Set Filter SELector - filter 2 */
                /* Set Lower Interval Boundary Slot ID */
                temp_value_1 |= (Fr_FIFO_config_ptr->FIFO_range_filters_config[2U].range_filter_lower_interval & 0x07FFU);
                Fr_CC_reg_ptr[FrRFRFCFR] = temp_value_1;    /* Store Range filter 2 settings */
            
                temp_value_2 = 0x0000U;                      /* Clear */
                temp_value_2 |= 0x2000U;                     /* Set Filter SELector - filter 2 */
                temp_value_2 |= FrRFRFCFR_IBD;              /* Program upper interval boundary */
                /* Set Upper Interval Boundary Slot ID */
                temp_value_2 |= (Fr_FIFO_config_ptr->FIFO_range_filters_config[2U].range_filter_upper_interval & 0x07FFU);
                Fr_CC_reg_ptr[FrRFRFCFR] = temp_value_2;    /* Store Range filter 2 settings */
            }

            /* Range filter 3 */
            if(Fr_FIFO_config_ptr->FIFO_range_filters_config[3U].range_filter_enable)  /* Range filter 3 enabled? */
            {
                temp_value_1 = 0x0000U;                      /* Clear */
                temp_value_1 |= 0x3000U;                     /* Set Filter SELector - filter 3 */
                /* Set Lower Interval Boundary Slot ID */
                temp_value_1 |= (Fr_FIFO_config_ptr->FIFO_range_filters_config[3U].range_filter_lower_interval & 0x07FFU);
                Fr_CC_reg_ptr[FrRFRFCFR] = temp_value_1;    /* Store Range filter 3 settings */
            
                temp_value_2 = 0x0000U;                      /* Clear */
                temp_value_2 |= 0x3000U;                     /* Set Filter SELector - filter 3 */
                temp_value_2 |= FrRFRFCFR_IBD;              /* Program upper interval boundary */
                /* Set Upper Interval Boundary Slot ID */
                temp_value_2 |= (Fr_FIFO_config_ptr->FIFO_range_filters_config[3U].range_filter_upper_interval & 0x07FFU);
            ...
            if(Fr_FIFO_config_ptr->FIFO_range_filters_config[0U].range_filter_mode == FR_REJECTION)  /* Filter 0 as rejection? */
            {
                temp_value_1 |= FrRFRFCTR_F0MD;             /* Range filter 0 as rejection filter */
            }
            if(Fr_FIFO_config_ptr->FIFO_range_filters_config[1U].range_filter_mode == FR_REJECTION)  /* Filter 1 as rejection? */
            {
                temp_value_1 |= FrRFRFCTR_F1MD;             /* Range filter 1 as rejection filter */
            }
            if(Fr_FIFO_config_ptr->FIFO_range_filters_config[2U].range_filter_mode == FR_REJECTION)  /* Filter 2 as rejection? */
            {
                temp_value_1 |= FrRFRFCTR_F2MD;             /* Range filter 2 as rejection filter */
            }
            if(Fr_FIFO_config_ptr->FIFO_range_filters_config[3U].range_filter_mode == FR_REJECTION)  /* Filter 3 as rejection? */
            {
        ...
        case FR_RECEIVE_SHADOW:         /* Configure receive shadow buffers */
            ...
            {   /* Enabled */
                ...
                /* Calculate the message buffer header  */
                header_MB_ptr = ((volatile uint16 PTR2FARDATA)(Fr_HW_config_ptr->CC_FlexRay_memory_base_address) + \
                                ((uint16)(Fr_shadow_buffer_config_ptr->RSBIR_A1_buffer_number_init) * 5U));
            ...
            {   /* Enabled */
                ...
                temp_value_1 |= 0x1000U;                     /* Selector field - ch A, seg 2 */
                Fr_CC_reg_ptr[FrRSBIR] = temp_value_1;      /* Store settings for shadow buffer, ch A, seg 2 */
                
                /* Calculate the message buffer header  */
                header_MB_ptr = ((volatile uint16 PTR2FARDATA)(Fr_HW_config_ptr->CC_FlexRay_memory_base_address) + \
                                ((uint16)(Fr_shadow_buffer_config_ptr->RSBIR_A2_buffer_number_init) * 5U));
            ...
            {   /* Enabled */
                ...
                temp_value_1 |= 0x2000U;                     /* Selector field - ch B, seg 1 */
                Fr_CC_reg_ptr[FrRSBIR] = temp_value_1;      /* Store settings for shadow buffer, ch B, seg 1 */
                
                /* Calculate the message buffer header  */
                header_MB_ptr = ((volatile uint16 PTR2FARDATA)(Fr_HW_config_ptr->CC_FlexRay_memory_base_address) + \
                                ((uint16)(Fr_shadow_buffer_config_ptr->RSBIR_B1_buffer_number_init) * 5U));
            ...
            {   /* Enabled */
                ...
                temp_value_1 |= 0x3000U;                     /* Selector field - ch B, seg 2 */
                Fr_CC_reg_ptr[FrRSBIR] = temp_value_1;      /* Store settings for shadow buffer, ch B, seg 2 */
                
                /* Calculate the message buffer header  */
                header_MB_ptr = ((volatile uint16 PTR2FARDATA)(Fr_HW_config_ptr->CC_FlexRay_memory_base_address) + \
                                ((uint16)(Fr_shadow_buffer_config_ptr->RSBIR_B2_buffer_number_init) * 5U));
...
void Fr_timers_init(const Fr_timer_config_type ** Fr_timer_config_temp_ptr_ptr)
{
    ...
    volatile uint16 temp_value_1;               /* Temporary variable used for bit operation */
    volatile uint16 temp_value_2;               /* Temporary variable used for bit operation */
    volatile uint16 temp_timer_config_reg = 0U;  /* Timer configuration and control register */
    ...
    while(Fr_timer_config_temp_ptr_ptr[temp_index] != NULL)   /* Configure all required timers */
    {
        ...
        case FR_ABSOLUTE:                   /* Configure absolute timer */
            if(Fr_timers_config_ptr->timer_ID == FR_TIMER_T1)    /* Configure FR module registers for timer T1 */
            {
                ...
                temp_value_1 = 0x0000U;                      /* Clear */
                /* Set cycle filter value  */
                temp_value_1 |= (uint16)((Fr_timers_config_ptr->timer_cycle_filter_value & 0x3FU) << 8U); 
                temp_value_1 |= (Fr_timers_config_ptr->timer_cycle_filter_mask & 0x3FU);         /* Set cycle filter mask */
                Fr_CC_reg_ptr[FrTI1CYSR] = temp_value_1;                                        /* Store Timer 1 Cycle Set reg. */
                
                /* Configure TI1MTOR register */
                temp_value_2 = 0x0000U;                      /* Clear */
                temp_value_2 |= (uint16)(Fr_timers_config_ptr->timer_macrotick_offset & 0x3FFFU); /* Set macrotick value */
            ...
            {
                /* Do nothing on error - only two timers available */
            }
        ...
        case FR_RELATIVE:                       /* Configure relative timer */
            if(Fr_timers_config_ptr->timer_ID == FR_TIMER_T2)   /* Configure FR module registers only for timer T2  */
            {
                /* Configure TI2CR0 register */
                temp_value_1 = 0x0000U;                      /* Clear */
                temp_value_1 |= (uint16)(Fr_timers_config_ptr->timer_macrotick_offset >> 16U);/* Set macrotick value - high word */
                Fr_CC_reg_ptr[FrTI2CR0] = temp_value_1;                                         /* Store Timer 2 Configuration 0 */
                
                /* Configure TI2CR1 register */
                temp_value_2 = 0x0000U;                      /* Clear */
                /* Set macrotick value - low word */
                temp_value_2 |= (uint16)(Fr_timers_config_ptr->timer_macrotick_offset & 0x0000FFFFU); 
                Fr_CC_reg_ptr[FrTI2CR1] = temp_value_2;                                         /* Store Timer 2 Configuration 1 */
...
void Fr_slot_status_init(const Fr_slot_status_config_type *Fr_slot_status_config_temp_ptr)
{
    ...
    temp_value_1 |= 0x1000U;                 /* Selector field - SSSR1 */
    ...
    temp_value_1 |= 0x2000U;                 /* Selector field - SSSR2 */
    ...
    temp_value_1 |= 0x3000U;                 /* Selector field - SSSR3 */
...
Fr_return_type Fr_leave_configuration_mode(void)
{
    ...
    i = 0U;      /* Clear temporary counter */
    while((i < FR_MAX_WAIT_CYCLES) && ( (Fr_CC_reg_ptr[FrPSR0] & 0x0700U) != FrPSR0_PROTSTATE_READY))
    {
        i++;        /* Increment temporary counter */
    }
    if(i == FR_MAX_WAIT_CYCLES)
...
Fr_return_type Fr_start_communication(void)
{
    ...
    temp_value_1 = (uint16)(Fr_CC_reg_ptr[FrPSR0] & 0x0700U);    /* Load Protocol State field of the PSR0 reg. */
...
{
    Fr_wakeup_state_type wakeup_state = FR_WAKEUPSTATE_UNDEFINED;   /* variable for storing wakeup state */   
    volatile uint16 temp_value_1 = 0U;     /* Temporary variable used for bit operation */

    /* Read current WAKEUPSTATUS */
    temp_value_1 = Fr_CC_reg_ptr[FrPSR0];
    temp_value_1 &= 0x0007U;                             /* Select only WAKEUPSTATUS field */
    
    switch(temp_value_1)                                /* Test Protocol State */
    {
    case 0x0000:                                        /* FR_WAKEUPSTATE_UNDEFINED */
        wakeup_state = FR_WAKEUPSTATE_UNDEFINED;        /* save current Wakeup State */
        break;
    case FrPSR0_WAKEUPSTATUS_RECEIVED_HEADER:           /* FR_WAKEUPSTATE_RECEIVED_HEADER */
        wakeup_state = FR_WAKEUPSTATE_RECEIVED_HEADER;  /* save current Wakeup State */
        break;
    case FrPSR0_WAKEUPSTATUS_RECEIVED_WUP:              /* FR_WAKEUPSTATE_RECEIVED_WUP */
        wakeup_state = FR_WAKEUPSTATE_RECEIVED_WUP;     /* save current Wakeup State */
        break;
    case FrPSR0_WAKEUPSTATUS_COLLISION_HEADER:          /* FR_WAKEUPSTATE_COLLISION_HEADER */
        wakeup_state = FR_WAKEUPSTATE_COLLISION_HEADER; /* save current Wakeup State */
        break;
    case FrPSR0_WAKEUPSTATUS_COLLISION_WUP:             /* FR_WAKEUPSTATE_COLLISION_WUP */
        wakeup_state = FR_WAKEUPSTATE_COLLISION_WUP;    /* save current Wakeup State */
        break;
    case FrPSR0_WAKEUPSTATUS_COLLISION_UNKNOWN:         /* FR_WAKEUPSTATE_COLLISION_UNKNOWN */
        wakeup_state = FR_WAKEUPSTATE_COLLISION_UNKNOWN;/* save current Wakeup State */
        break;
    case FrPSR0_WAKEUPSTATUS_TRANSMITTED:               /* FR_WAKEUPSTATE_TRANSMITTED */
        wakeup_state = FR_WAKEUPSTATE_TRANSMITTED;      /* save current Wakeup State */
        break;    
    default:
        break;
    }
    return wakeup_state;                                /* return saved state */
}
...
*                   FR_POCSTATE_WAKEUP    CC sends a wakeup pattern if it couldn抰 find 
*                                   anything on the bus
*                   FR_POCSTATE_UNKNOWN Returned value if an error has occured
*                   
*************************************************************************************/
Fr_POC_state_type Fr_get_POC_state(void)
{
    Fr_POC_state_type poc_state = FR_POCSTATE_UNKNOWN;  /* Variable for return POC state */
    volatile uint16 temp_value_1 = 0U;                   /* Temporary variable used for bit operation */
    ...
    if(temp_value_1 & FrPSR1_FRZ)
    {
        poc_state = FR_POCSTATE_HALT;  /* The FlexRay module is in FR_POCSTATE_HALT state  */   
    }
    else
    {
        /* Read current FR_POCSTATE */
        temp_value_1 = Fr_CC_reg_ptr[FrPSR0];
        temp_value_1 &= 0x0700U;                     /* Select only PROSTATE field */
        
        switch(temp_value_1)                        /* Test Protocol State */
        {
        case FrPSR0_PROTSTATE_DEFAULT_CONFIG:       /* FR_POCSTATE_DEFAULT_CONFIG */
            poc_state = FR_POCSTATE_DEFAULT_CONFIG; /* save current Protocol State */
            break;
        case FrPSR0_PROTSTATE_CONFIG:               /* FR_POCSTATE_CONFIG */
            poc_state = FR_POCSTATE_CONFIG;         /* save current Protocol State */
            break;
        case FrPSR0_PROTSTATE_WAKEUP:               /* FR_POCSTATE_WAKEUP */
            poc_state = FR_POCSTATE_WAKEUP;         /* save current Protocol State */
            break;
        case FrPSR0_PROTSTATE_READY:                /* FR_POCSTATE_READY */
            poc_state = FR_POCSTATE_READY;          /* save current Protocol State */
            break;
        case FrPSR0_PROTSTATE_NORMAL_PASSIVE:       /* FR_POCSTATE_READY */
            poc_state = FR_POCSTATE_NORMAL_PASSIVE; /* save current Protocol State */
            break;
        case FrPSR0_PROTSTATE_NORMAL_ACTIVE:        /* FR_POCSTATE_NORMAL_ACTIVE */
            poc_state = FR_POCSTATE_NORMAL_ACTIVE;  /* save current Protocol State */
            break;
        case FrPSR0_PROTSTATE_HALT:                 /* FR_POCSTATE_HALT */
            poc_state = FR_POCSTATE_HALT;           /* save current Protocol State */
            break;    
        case FrPSR0_PROTSTATE_STARTUP:              /* FR_POCSTATE_STARTUP */
            poc_state = FR_POCSTATE_STARTUP;        /* save current Protocol State */
            break;
        default:
            break;
        }
...
Fr_sync_state_type Fr_get_sync_state(void)
{
    ...
    if(temp_value_1 & FrPSR1_FRZ)
    {
       return FR_ASYNC;  /* The FlexRay module is in FR_POCSTATE_HALT state - not synchronous */
    }
    ...
    {
        return FR_ASYNC;                       /* This FlexRay module is not synchronous to the cluster */
    }
}
...
Fr_return_type Fr_enter_configuration_mode(void)
{
    ...
    {   /* Yes */
        ...
        /* Check the version of the FlexRay module */
        if((Fr_connected_HW == FR_MPC5510_0M22M) || (Fr_connected_HW == FR_MPC560xP))
        {   /* For MPC5517 and MPC560xP */
            /* Wait till Protocol Command Write is not busy */
            while((i < FR_MAX_WAIT_CYCLES) && (Fr_CC_reg_ptr[FrPOCR] & FrPOCR_BSY))
            {
                i++;        /* Increment temporary counter */
        ...
        {
            /* Execute Protocol Reset Command sequence for older versions of FlexRay module
               Protocol Reset Command sequence - to solve an issue (MUCts03059) described in Errata Document
               Start of sequence, Repeatedly send the command FREEZE, until the freeze bit is set
            ...
            while(((Fr_CC_reg_ptr[FrPSR1] & FrPSR1_FRZ) == FrPSR1_FRZ) || \
                    ((Fr_CC_reg_ptr[FrPSR0] & 0x0700U) != FrPSR0_PROTSTATE_DEFAULT_CONFIG))
            {
                i = 0U;      /* Clear temporary counter */
                /* Wait till Protocol Command Write is not busy */
                while((i < FR_MAX_WAIT_CYCLES) && (Fr_CC_reg_ptr[FrPOCR] & FrPOCR_BSY))
        ...
        while((i < FR_MAX_WAIT_CYCLES) && ((Fr_CC_reg_ptr[FrPSR0] & 0x0700U) != FrPSR0_PROTSTATE_DEFAULT_CONFIG))
        {
            i++;        /* Increment temporary counter */
        }
        if(i == FR_MAX_WAIT_CYCLES) 
...
{
    Fr_return_type return_type = FR_SUCCESS;    /* Variable for storing return value */
    volatile uint16 temp_value_1;               /* Temporary variable used for bit operation */
    volatile uint16 temp_value_2;               /* Temporary variable used for bit operation */

    temp_value_1 = (uint16)(Fr_MTS_config_temp_ptr->cycle_counter_value & 0x3FU);    /* Cycle counter value */
    temp_value_2 = (uint16)(Fr_MTS_config_temp_ptr->cycle_counter_mask & 0x3FU);     /* Cycle counter mask */
    temp_value_1 |= (uint16)(temp_value_2 << 8U);    /* Move the CYCCNTMSK bit field */
    ...
    {
        return_type = FR_NOT_SUCCESS;           /* Incorrect value of the Fr_channel inserted */
    }
    
    return return_type;                         /* API call has been successful */
}
...
*                                               a Boundary Violation has been detected
*                   FR_MTS_UNKNOWN          Returned value if an error has occured
*
*************************************************************************************/
Fr_MTS_state_type Fr_get_MTS_state(Fr_channel_type Fr_channel)
{
    Fr_MTS_state_type mts_state = FR_MTS_UNKNOWN;   /* Return variable for MTS state */
    volatile uint16 temp_value_1;                   /* Temporary variable used for bit operation */
    ...
    {
         mts_state = FR_MTS_NOT_RCV;   
    }
    
    return mts_state;   /* return MTS state */
}
...
void Fr_get_network_management_vector(uint16 * Fr_vector_ptr)
{
    ...
    temp_value_2 = (uint16)(temp_value_1 / 2U);            /* Divide the length by 2 - conversion Bytes -> Words */
    
    if(temp_value_1 & 0x0001U)                   /* Is the length the odd number? */
    ...
    for(Fr_p = 0U; Fr_p < temp_value_2; Fr_p++)
    {
                            ...
                            Fr_slot_status_required_type Fr_slot_status_required, uint16 *Fr_status_vector_ptr)
{
    ...
    if(Fr_slot_number == 0U)     /* Symbol window or the NIT status vector is required */
    {
    ...
    {
        Fr_selection_register = 0U;          /* Required slot is monitored by means od SSR0 or SSR1 register */
    }
    ...
    {
        Fr_selection_register = 1U;          /* Required slot is monitored by means od SSR2 or SSR3 register */
    }
    ...
    {
        Fr_selection_register = 2U;          /* Required slot is monitored by means od SSR4 or SSR5 register */
    }
    ...
    {
        Fr_selection_register = 3U;          /* Required slot is monitored by means od SSR6 or SSR7 register */
    }
    ...
    {                               /* The slot status registers have been already configured */
        ...
        {       /* The newest updated slot status information is required from given slot */
            if(Fr_current_slot_greater)            /* Has been status vector already stored in this communication cycle? */
            {
                ...
                if(Fr_current_cycle & 0x01U)     /* Determine if the cycle number is odd or even */
...
void Fr_reset_slot_status_counter(Fr_slot_status_counter_ID_type Fr_counter_idx)
{
    ...
    Fr_CC_reg_ptr[FrSSCCR] = (uint16)(temp_value_1 | FrSSCCR_WMD);  /* Select related SSCCRn for following reading */
    /* Load content of related SSCCRn register and select the important bits */
    temp_value_2 = (uint16)(Fr_CC_reg_ptr[FrSSCCR] & 0x07FFU);   
    temp_value_1 |= (temp_value_2 & (uint16)(~FrSSCCR_MCY));    /* Clear the MCY bit */
...
{
    Fr_tx_MB_status_type return_type = FR_TXMB_UPDATED;
    volatile uint16 PTR2FARDATA header_MB_ptr;        /* Message buffer header pointer */
    volatile uint16 PTR2FARDATA Fr_CC_data_ptr;       /* Reference to data array */
    volatile uint16 temp_value_1 = 0U, temp_value_2 = 0U; /* Temporary variables used for bit operation */
    volatile uint16 Fr_MB_registers_offset_add_temp; /* Temporary offset adress of message buffer registers */
    uint16 Fr_p;                                        /* Temporary counter used for copying */
    
    /* Temporary offset address of MB registers */
    Fr_MB_registers_offset_add_temp = (uint16)(Fr_buffer_idx * 4U);

    /* Read the MB Configuration, Control and Status reg. */
    /* Load MBCCSRn register and select only necessary bits */
    temp_value_1 = (uint16)(Fr_CC_reg_ptr[FrMBCCSR0 + Fr_MB_registers_offset_add_temp] & 0xF900U);
    ...
    {                                           /* Yes */
        ...
        temp_value_2 &= 0xF900U;                 /* Select only necessary bits     */
        ...
        /* Calculate the message buffer header  */
        header_MB_ptr = ((volatile uint16 PTR2FARDATA)(Fr_HW_config_ptr->CC_FlexRay_memory_base_address) + (Fr_buffer_idx * 5U));
        
        /* Calculate MB Data pointer */
        Fr_CC_data_ptr = ((volatile uint16 PTR2FARDATA)(Fr_HW_config_ptr->CC_FlexRay_memory_base_address) + \
                         (header_MB_ptr[3U] / 2U));

        /* Test if given data length is not zero, then read length from  */
        if(Fr_data_length == 0U)
        {
            /* Load the data payload length value from Frame header register */
            Fr_data_length = (uint8)(header_MB_ptr[1U] & 0x007FU);
        }
        
        /* Copy data */
        for(Fr_p = 0U; Fr_p < Fr_data_length; Fr_p++)
        {
    ...
    else
    {
        ...
        temp_value_2 = (uint16)(Fr_CC_reg_ptr[FrMBCCSR0 + Fr_MB_registers_offset_add_temp] & 0xF900U);
        temp_value_2 |= FrMBCCSR_MBIF;          /* Set MBIF flag - clear TX MB interrupt flag  */
        Fr_CC_reg_ptr[FrMBCCSR0 + Fr_MB_registers_offset_add_temp] = temp_value_2;  /* Clear Transmit Buffer Interrupt Flag */
        return_type = FR_TXMB_NO_ACCESS;       /* The transmit MB has not been successfully locked */
    }
    return return_type;                 /* The transmit MB has been updated with new data */
}
...
*                   will be returned and the length ??will be stored in Fr_data_length.
...
{
    Fr_rx_MB_status_type returnValue = FR_RXMB_RECEIVED;    /* Variable for return value */
    volatile uint16 PTR2FARDATA header_MB_ptr;    /* Message buffer header pointer */
    volatile uint16 PTR2FARDATA Fr_CC_data_ptr;   /* Reference to data array */
    volatile uint16 temp_value_1 = 0U;              /* Temporary variable used for bit operation */
    volatile uint16 temp_value_2 = 0U;              /* Temporary variable used for bit operation */
    volatile uint16 Fr_MB_registers_offset_add_temp;/* Temporary offset adress of message buffer registers */
    volatile uint8 Fr_data_length = 0U;             /* Data payload length */
    uint16 Fr_p;                                    /* Temporary counter used for copying */
    ...
    temp_value_1 |= FrMBCCSR_LCKT;      /* Set Lock Trigger bit */
    Fr_CC_reg_ptr[FrMBCCSR0 + Fr_MB_registers_offset_add_temp] = temp_value_1;  /* Lock MB and clear interrupt */
    /* Clear Receive Buffer Interrupt Flag */    
    temp_value_1 &= 0xF900U;                /* Select only necessary bits */
    ...
    /* Read the MB again for checking if the MB is locked */
    temp_value_1 = Fr_CC_reg_ptr[FrMBCCSR0 + Fr_MB_registers_offset_add_temp];  
    if(temp_value_1 & FrMBCCSR_LCKS)             /* Is the MB locked? */
    {/* Yes, MB is locked */
        /* Calculate the message buffer header  */
        header_MB_ptr = ((volatile uint16 PTR2FARDATA)(Fr_HW_config_ptr->CC_FlexRay_memory_base_address)\
                        + (Fr_CC_reg_ptr[FrMBIDXR0 + Fr_MB_registers_offset_add_temp] * 5U));
        
        /* Read Slot Status  */
        temp_value_2 = header_MB_ptr[4U];        /* Load Slot Status Information */
        *Fr_slot_status_ptr = temp_value_2;      /* Store the slot status into Fr_slot_status_ptr */
  
        if(Fr_MB_information_internal[Fr_buffer_idx].slot_number <= Fr_low_level_config_ptr->G_NUMBER_OF_STATIC_SLOTS) 
        {/* MB is configured for the static segment */
            ...
            {/* DUP == 0 : Data has not been updated, however NULL frame may have been received */
                ...
                {/* Yes, DUP == 0 and VFA or VFB == 1 -> NFA or NFB == 0 -> valid null frame receved */
                    returnValue = FR_RXMB_NULL_FRAME_RECEIVED;  /* Valid null frame has been received */
                }
                else    
                {/* No valid frame received */
                    returnValue = FR_RXMB_NOT_RECEIVED;         /* No valid frame has been received */
                }
            }
        }
        else
        {/* MB is configured for the dynamic segment */
            /* If MBIF == 1 : Frame status updated */
            if(temp_value_1 & FrMBCCSR_MBIF) 
            {/* Yes, Valid frame received */
                /* Calculate MB Data pointer */
                Fr_CC_data_ptr = ((volatile uint16 PTR2FARDATA)(Fr_HW_config_ptr->CC_FlexRay_memory_base_address) + \
                                 (header_MB_ptr[3U] / 2U));
                /* Load the data payload length value from Frame header register */
    ...
    {/* No, MB isn't locked */
        returnValue = FR_RXMB_NO_ACCESS;          /* The receive MB has not been successfully locked */
    }
                                        ...
                                        uint16 *Fr_slot_idx_ptr, uint16 *Fr_slot_status_ptr)
{
    ...
    /* Calculate the message buffer header  */
    header_MB_ptr = ((volatile uint16 PTR2FARDATA)(Fr_HW_config_ptr->CC_FlexRay_memory_base_address) + \
                    (Fr_buffer_read_idx * 5U));

    /* Read Slot Status  */
    temp_value_1 = header_MB_ptr[0U];                /* Load MB header field */
    temp_value_2 = header_MB_ptr[4U];                /* Load Slot Status Information */
    *Fr_slot_status_ptr = temp_value_2;             /* Store the slot status into Fr_slot_status_ptr */
    *Fr_slot_idx_ptr = (uint16)(header_MB_ptr[0U] & 0x07FFU); /* Store the Frame ID into Fr_slot_idx_ptr */
...
void Fr_disable_interrupts(uint16 Fr_global_interrupt, uint16 Fr_protocol_0_interrupt, uint16 Fr_protocol_1_interrupt)
{
    ...
    if(Fr_global_interrupt)             /* Fr_global_interrupt parameter is not equal to zero */
    {
        ...
        temp_value_1 = Fr_CC_reg_ptr[FrGIFER];  /* Load content of GIFER reg. */
        temp_value_1 &= (uint16)(~Fr_global_interrupt); /* Clear bit(s) */
        Fr_CC_reg_ptr[FrGIFER] = temp_value_1;  /* Store new settings */
    }
    temp_value_1 = 0x0000U;              /* Clear variable */
    if(Fr_protocol_0_interrupt)         /* Fr_protocol_0_interrupt parameter is not equal to zero */
    {
        ...
        temp_value_1 = Fr_CC_reg_ptr[FrPIER0];      /* Load content of PIER0 reg. */
        temp_value_1 &= (uint16)(~Fr_protocol_0_interrupt); /* Clears bit(s) */
        Fr_CC_reg_ptr[FrPIER0] = temp_value_1;      /* Store new settings */
    }
    temp_value_1 = 0x0000U;              /* Clear variable */
    if(Fr_protocol_1_interrupt)         /* Fr_protocol_1_interrupt parameter is not equal to zero */
    {
        ...
        temp_value_1 = Fr_CC_reg_ptr[FrPIER1];      /* Load content of PIER0 reg. */
        temp_value_1 &= (uint16)(~Fr_protocol_1_interrupt); /* Clear bit(s) */
        Fr_CC_reg_ptr[FrPIER1] = temp_value_1;      /* Store new settings */
    }
}
...
void Fr_interrupt_handler(void)
{
    ...
    temp_isr_event = (uint16)(isr_event & 0x00FFU);  /* Select only lower eight bit */
    isr_event &= (uint16)(temp_isr_event << 8U);     /* Move selected bits and separate only enabled interrupt flags */
        
    if((isr_event & FrGIFER_TBIF) != 0U)     /* Transmit buffer interrupt flag set? */
    {   /* Yes, tx interrupt occured */
        buffer_idx = (uint8)((Fr_CC_reg_ptr[FrMBIVEC] & 0x7F00U) >> 8U); /* Read Transmit Buffer Interrupt Vector */
    ...
    if((isr_event & FrGIFER_RBIF) != 0U)     /* Receive buffer interrupt flag set? */
    {   /* Yes, rx interrupt occured */
        buffer_idx = (uint8)(Fr_CC_reg_ptr[FrMBIVEC] & 0x007FU);    /* Read Receive Buffer Interrupt Vector */
        if(Fr_MB_information_internal[buffer_idx].Fr_MB_function_ptr != NULL)       /* Service callback function was configured? */
        {
            Fr_MB_information_internal[buffer_idx].Fr_MB_function_ptr(buffer_idx);  /* Call service callback function */
        }
    }
    if((isr_event & FrGIFER_FNEAIF) != 0U)     /* FIFO A interrupt flag set? */
    {   /* Yes, FIFO A Not empty interrupt occured */
        buffer_fifo_idx = (uint16)(Fr_CC_reg_ptr[FrRFARIR] & 0x03FFU);   /* Read Receive FIFO A Read Index */
        ...
        temp_value_1 = (uint16)(Fr_CC_reg_ptr[FrGIFER] & 0xE3FFU);
        Fr_CC_reg_ptr[FrGIFER] = (uint16)(FrGIFER_FNEAIF | temp_value_1);   /* Clear interrupt flag */
    }
    if((isr_event & FrGIFER_FNEBIF) != 0U)     /* FIFO B interrupt flag set? */
    {   /* Yes, FIFO B Not empty interrupt occured */
        buffer_fifo_idx = (uint8)(Fr_CC_reg_ptr[FrRFBRIR] & 0x03FFU);    /* Read Receive FIFO B Read Index */
        ...
        /* Read the GIFER reg. and clear the WUPIF, FNEBIF and FNEAIF bits */
        temp_value_2 = (uint16)(Fr_CC_reg_ptr[FrGIFER] & 0xE3FFU);
        Fr_CC_reg_ptr[FrGIFER] = (uint16)(FrGIFER_FNEBIF | temp_value_2);   /* Clear interrupt flag */
    }
    if((isr_event & FrGIFER_WUPIF) != 0U)     /* Wakeup interrupt flag set? */
    {   /* Yes, Wakeup interrupt occured */
        ...
        /* Read the GIFER reg. and clear the WUPIF, FNEBIF and FNEAIF bits */
        temp_value_2 = (uint16)(Fr_CC_reg_ptr[FrGIFER] & 0xE3FFU);
        Fr_CC_reg_ptr[FrGIFER] = (uint16)(FrGIFER_WUPIF | temp_value_2);    /* Clear interrupt flag */
    }

    if((isr_event & FrGIFER_CHIF) != 0U)         /* CHI interrupt flag set? */
    ...
    if((isr_event & FrGIFER_PRIF) != 0U)     /* Protocol interrupt flag set? */
    {   /* Yes, protocol interrupt occured */
        ...
        /* PIFR0 register */
        if((isr_prif_0_event & FR_CYCLE_START_IRQ) != 0U)                /* Cycle Start interrupt flag set? */
        ...
        if((isr_prif_0_event & FR_TIMER_1_EXPIRED_IRQ) != 0U)            /* Timer 1 expired interrupt flag set? */
        {   /* Yes, timer 1 expired */
        ...
        if((isr_prif_0_event & FR_TIMER_2_EXPIRED_IRQ) != 0U)            /* Timer 2 expired interrupt flag set? */
        {   /* Yes, timer 2 expired */
        ...
        /* Transmission across boundary occured on channel A? */
        if((isr_prif_0_event & FR_TRANSMISSION_ACROSS_BOUNDARY_CHA_IRQ) != 0U)
        ...
        /* Transmission across boundary occured on channel B? */
        if((isr_prif_0_event & FR_TRANSMISSION_ACROSS_BOUNDARY_CHB_IRQ) != 0U)
        {   /* Yes, transmission across boundary occured */
        ...
        if((isr_prif_0_event & FR_VIOLATION_CHA_IRQ) != 0U)              /* pLatestTx violation occured on channel A? */
        ...
        if((isr_prif_0_event & FR_VIOLATION_CHB_IRQ) != 0U)              /* pLatestTx violation occured on channel B? */
        {   /* Yes, pLatestTx violation occured */
        ...
        if((isr_prif_0_event & FR_MEDIA_ACCESS_TEST_SYMBOL_RECEIVED_IRQ) != 0U)  /* MTS symbol received? */
        ...
        if((isr_prif_0_event & FR_MAX_SYNC_FRAMES_DETECTED_IRQ) != 0U)   /* Max Sync Frames Detected? */
        ...
        if((isr_prif_0_event & FR_CLOCK_CORRECTION_LIMIT_IRQ) != 0U)     /* Clock correction limit reached? */
        ...
        if((isr_prif_0_event & FR_MISSING_OFFSET_CORRECTION_IRQ) != 0U)  /* Missing Offset Correction Interrupt? */
        ...
        if((isr_prif_0_event & FR_MISSING_RATE_CORRECTION_IRQ) != 0U)    /* Missing Rate Correction Interrupt? */
        ...
        if((isr_prif_0_event & FR_COLDSTART_ABORT_IRQ) != 0U)            /* Coldstart Abort Interrupt? */
        ...
        if((isr_prif_0_event & FR_ILLEGAL_PROTOCOL_CONFIGURATION_IRQ) != 0U) /* Illegal protocol congiguration detected? */
        ...
        if((isr_prif_0_event & FR_INTERNAL_PROTOCOL_ERROR_IRQ) != 0U)    /* Internal protocol error detected? */
        ...
        if((isr_prif_0_event & FR_FATAL_PROTOCOL_ERROR_IRQ) != 0U)       /* Fatal protocol error detected? */
        ...
        /* PIFR1 register */
        if((isr_prif_1_event & FR_ERROR_MODE_CHANGED_IRQ) != 0U)         /* Error mode Changed Interrupt? */
        ...
        if((isr_prif_1_event & FR_ILLEGAL_PROTOCOL_COMMAND_IRQ) != 0U)   /* Illegal protocol command detected? */
        ...
        if((isr_prif_1_event & FR_PROTOCOL_ENGINE_COM_FAILURE) != 0U)    /* Protocol engine communication failure detected? */
        ...
        if((isr_prif_1_event & FR_PROTOCOL_STATE_CHANGED_IRQ) != 0U)     /* Protocol state changed? */
        ...
        if((isr_prif_1_event & FR_SLOT_STATUS_COUNTER_3_INCREMENTED_IRQ) != 0U)  /* Slot status counter 3 incremented? */
        ...
        if((isr_prif_1_event & FR_SLOT_STATUS_COUNTER_2_INCREMENTED_IRQ) != 0U)  /* Slot status counter 2 incremented? */
        ...
        if((isr_prif_1_event & FR_SLOT_STATUS_COUNTER_1_INCREMENTED_IRQ) != 0U)  /* Slot status counter 1 incremented? */
        ...
        if((isr_prif_1_event & FR_SLOT_STATUS_COUNTER_0_INCREMENTED_IRQ) != 0U)  /* Slot status counter 0 incremented? */
        ...
        if((isr_prif_1_event & FR_EVEN_CYCLE_TABLE_WRITTEN_IRQ) != 0U)           /* Even cycle table written? */
        ...
        if((isr_prif_1_event & FR_ODD_CYCLE_TABLE_WRITTEN_IRQ) != 0U)           /* Odd cycle table written? */
        {   /* Yes, sync frame measurement table written */
    ...
    if((isr_event & FrGIFER_MIF) != 0U)         /* Module interrupt flag set? */
...
Fr_return_type Fr_set_global_IRQ_callback(void (* callback_ptr)(void), uint16 Fr_global_interrupt)
{
    ...
    default:
        return_type = FR_NOT_SUCCESS;      /* API call has not been successful - wrong parameter */
        break;
    }
    return return_type;              /* return stored return value */
}
...
{
    volatile uint16 temp_value_1 = 0U, temp_value_2 = 0U; /* Temporary variable used for bit operation */
    volatile uint16 Fr_MB_registers_offset_add_temp; /* Temporary offset adress of message buffer registers */
    ...
    if(Fr_MB_information_internal[Fr_buffer_idx].transmission_mode == FR_DOUBLE_TRANSMIT_BUFFER)
    {
        ...
        temp_value_2 = Fr_CC_reg_ptr[FrMBCCSR0 + Fr_MB_registers_offset_add_temp + 4U];
        ...
        /* MB works in the EVENT transmission mode, CMT bit has to be check at the transmit side and also at the commit side */
        {
...
Fr_rx_status_type Fr_check_rx_status(uint8 Fr_buffer_idx)
{
    ...
    /* Check whether is the buffer configured for dynamic or static segmnet */
    if(Fr_MB_information_internal[Fr_buffer_idx].slot_number<=Fr_low_level_config_ptr->G_NUMBER_OF_STATIC_SLOTS) 
    {   /* Slot is configured for the static segment */
        /* If DUP == 1 : Frame header and MB data field updated */
        if(temp_value_1 & FrMBCCSR_DUP) 
        {   /* Yes, Valid non-null frame received */
            return FR_RECEIVED;                /* Valid non-null frame received */
        }
        else    /* Data has not been updated, however NULL frame may have been received */
        {
            /* Load current MB index of message buffer header field */
            Fr_buffer_idx = (uint8) Fr_CC_reg_ptr[FrMBIDXR0 + Fr_MB_registers_offset_add_temp];
    ...
    {   /* Slot is configured for the dynamic segment */
        /* If MBIF == 1 : Slot status updated */
        if(temp_value_1 & FrMBCCSR_MBIF) /* Check the Message buffer interupt Flag in the dynamic segment */
        {   /* Yes, Valid frame received */
            return FR_RECEIVED;                /* Valid frame received */
        }
        else
        {   /* No, Valid frame not recceived*/
            return FR_NOT_RECEIVED;            /* No valid frame has been received */   
        }
    }
}
...
Fr_CHI_error_type Fr_check_CHI_error(void)
{
    ...
    if(temp_value_1 != 0U)                       /* Clear flags */
    {
...
{
    boolean bRet = FALSE;                                           /* Variable for return value */
    if(Fr_CC_reg_ptr[FrPIFR0] & FR_CYCLE_START_IRQ)
    {
        *Fr_cycle_ptr = (uint8)(Fr_CC_reg_ptr[FrCYCTR] & 0x003FU);   /* Store the number of current communication cycle */
        Fr_CC_reg_ptr[FrPIFR0] = FR_CYCLE_START_IRQ;                /* Clear interrupt flag */
        bRet =  TRUE;                                               /* Return TRUE - communication cycle has already started */
    }
    return bRet;                                                    /* Return value stored in bRet */
}
...
boolean Fr_check_transmission_across_boundary(Fr_channel_type Fr_channel)
{
    ...
    case FR_CHANNEL_A:                         /* Channel A */
        ...
        {   /* Yes, Transmission across boundary violation occured on channel A */
            Fr_CC_reg_ptr[FrPIFR0] = FR_TRANSMISSION_ACROSS_BOUNDARY_CHA_IRQ;    /* Clear interrupt flag */
            bRet =  TRUE;                    /* Store TRUE - Interrupt has been occurred on channel A */
        }
        break;
    case FR_CHANNEL_B:                        /* Channel B */
        ...
        {   /* Yes, Transmission across boundary violation occured on channel B */
            Fr_CC_reg_ptr[FrPIFR0] = FR_TRANSMISSION_ACROSS_BOUNDARY_CHB_IRQ;   /* Clear interrupt flag */
            bRet =  TRUE;                    /* Store TRUE - Interrupt has been occurred on channel B */
        }
        break;
    case FR_CHANNEL_AB:                        /* Both channels */
        ...
        {                                   /* Transmission across boundary violation occured on channel A and/or B */
            ...
            bRet =  TRUE;                    /* Store TRUE - Interrupt has been occurred on channel A and/or channel B */
        }
        break;
    case FR_NO_CHANNEL: /* Intentional fall through - no channel is configured */
    default:
        break;
    }
    return bRet;                           /* Return value stored in bRet */
...
*                   none
* Return value:
*                   FALSE   The number of synchronization frames doesn抰 exceed the value 
...
boolean Fr_check_max_sync_frame(void)
{
    ...
    {   /* Yes, Max Sync Frames Detected interrupt occured */
        Fr_CC_reg_ptr[FrPIFR0] = FR_MAX_SYNC_FRAMES_DETECTED_IRQ;   /* Clear interrupt flag */
        bRet = TRUE;                    /* Save TRUE - Error flag has been set */
    }
...
boolean Fr_check_clock_correction_limit_reached(void)
{
    ...
    {   /* Yes, Clock Correction Limit Reached interrupt occured */
        Fr_CC_reg_ptr[FrPIFR0] = FR_CLOCK_CORRECTION_LIMIT_IRQ;      /* Clear interrupt flag */
        bRet = TRUE;                    /* Store TRUE - Error flag has been set */
    }
...
boolean Fr_check_protocol_engine_com_failure(void)
{
    ...
    {   /* Yes, Protocol State Changed interrupt occured */
        Fr_CC_reg_ptr[FrPIFR1] = FR_PROTOCOL_ENGINE_COM_FAILURE;   /* Clear interrupt flag */
        bRet = TRUE;                    /* Return TRUE - Error flag has been set */
    }
...
uint16 Fr_low_level_access_read_memory(uint16 Fr_memory_address)
{
    ...
    return *((volatile uint16 PTR2FARDATA)(Fr_HW_config_ptr->CC_FlexRay_memory_base_address) + (Fr_memory_address / 2U));
}
...
void Fr_low_level_access_write_memory(uint16 Fr_memory_address, uint16 Fr_value)
{
    ...
    *((volatile uint16 PTR2FARDATA)(Fr_HW_config_ptr->CC_FlexRay_memory_base_address) + (Fr_memory_address / 2U)) = Fr_value;
}
